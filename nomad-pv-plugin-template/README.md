...
```sh
git clone https://github.com/Nikolai-KRAUS/nomad-pv-plugin-template.git
cd nomad-pv-plugin-template
...
| Name | E-mail     |
|------|------------|
| Nikolai Kraus | [nikolai.kraus@uibk.ac.at](mailto:nikolai.kraus@uibk.ac.at)
