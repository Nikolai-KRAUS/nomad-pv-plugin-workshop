...
class NewParserEntryPoint(ParserEntryPoint):
    ...
    def load(self):
        from nomad_pv_plugin_workshop.parsers.parser import NewParser
...
class fooExperimentParserEntryPoint(ParserEntryPoint):
    ...
    def load(self):
        from nomad_pv_plugin_workshop.parsers.foo_batch_parser import fooExperimentParser
...
class fooParserEntryPoint(ParserEntryPoint):
    ...
    def load(self):
        from nomad_pv_plugin_workshop.parsers.foo_measurement_parser import fooParser
